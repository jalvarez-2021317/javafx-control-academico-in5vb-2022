package org.in5bv.carlosperezjoshuaalvarez.reports;
...
public class GenerarReporte {
    ...
    public void mostrarReporte(String nombreReporte, Map<String, Object> parametros, String titulo) {
        ...
        try {
            ...
            parametros.put("LOGO_HEADER", PAQUETE_IMAGES + "kinal.png");
            parametros.put("LOGO_FOOTER", PAQUETE_IMAGES + "footer.png");
